...
import { FaBoxes, FaChartPie, FaCubes, FaLayerGroup } from "react-icons/fa";
...
const StaffTable = ({ staffList, loading, onView, onEdit, onDelete, onComponents }) => (
  <div className="overflow-x-auto overflow-y-auto h-92  rounded shadow-lg border border-slate-700 bg-slate-800 backdrop-blur-lg">
            ...
            >
              ...
              <td className="px-6 py-4 text-center align-middle">
                <FaChartPie
                  ...
                  className="mx-auto inline-block w-5 h-5 text-indigo-400 hover:scale-110 cursor-pointer transition-transform"
                />
              </td>
            </tr>
          ))
  ...
  <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
    <div className="bg-slate-900 p-8 rounded-xl w-11/12 max-w-xl relative border border-slate-700 shadow-lg">
      ...
      <div className="space-y-3 text-slate-300">
        <p>
          <span className="text-teal-300">Name:</span> {formatValue(staff.name)}
        </p>
        <p>
      ...
      {loading || shimmerDelay ? (
        ...
        <>
          <button
            ...
            className="mb-4 px-4 py-2 bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-lg font-semibold"
          >
            ← Back to Staff List
          </button>
          
           <SalaryComponentCrud baseUrl={`http://localhost:8081/api/staff/${showComponentsFor.id}/components`}
        ...
        <>
          ...
          <StaffTable
            ...
            onComponents={(staff) => setShowComponentsFor(staff)} // ✅ handle components view
          />
